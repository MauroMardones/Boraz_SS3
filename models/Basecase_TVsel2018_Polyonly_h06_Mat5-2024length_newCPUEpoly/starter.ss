...
#C file write time: 2018-12-24 20:44:51
sbr_dat.ss
sbr_ctl.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1968
...
5 # F_std_reporting_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Apical_F's); 4=mean F for range of ages (numbers weighted); 5=unweighted mean F for range of ages
2 8 # min and max age over which mean F will be calculated, with F=Z-M
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1709820929
